      ...
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="space-y-6">
          <div className="p-4 bg-gray-50 rounded-lg">
            <h3 className="font-medium text-gray-700 mb-2">Basic Ping</h3>
            <p className="text-gray-600">
              Status: {pingQuery.isLoading ? 'Loading...' : pingQuery.data}
            </p>
          </div>

          <div className="p-4 bg-gray-50 rounded-lg">
            <h3 className="font-medium text-gray-700 mb-2">Advanced Ping</h3>
            <p className="text-gray-600">
              Status: {advancedPing.isLoading ? 'Loading...' : advancedPing.data}
            </p>
          </div>
        </div>
      </div>
